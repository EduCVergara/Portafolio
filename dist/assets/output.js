(() => {
  ...
  // node_modules/.pnpm/sweetalert2@11.26.17/node_modules/sweetalert2/dist/sweetalert2.all.js
  var require_sweetalert2_all = __commonJS({
    "node_modules/.pnpm/sweetalert2@11.26.17/node_modules/sweetalert2/dist/sweetalert2.all.js"(exports, module) {
...
`;
  ...
  me.addEventListener("click", () => {
    import_sweetalert2.default.fire({
      ...
      draggable: true,
      footer: '<a href="https://www.linkedin.com/in/educonstancio/">\xBFQuieres saber m\xE1s de m\xED?, haz click aqu\xED</a>',
      showCloseButton: true,
      html: "\xA1Si, soy yo! <br><span>Me cerrar\xE9 en <b></b> milisegundos si no presionas nada \u{1F440}.</span>",
      timer: 3e3,
      timerProgressBar: true,
      didOpen: () => {
        import_sweetalert2.default.showLoading();
        const timer = import_sweetalert2.default.getPopup().querySelector("b");
        timerInterval = setInterval(() => {
          timer.textContent = `${import_sweetalert2.default.getTimerLeft()}`;
        }, 100);
      },
      willClose: () => {
